...
use Gearbox\MediaBundle\Entity\Collection;
use Gearbox\MediaBundle\Form\CollectionType;
...
class CollectionController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('media_collection_show', array('id' => $entity->getId())));
        }

        return $this->render('GearboxMediaBundle:Collection:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Collection $entity)
    {
        $form = $this->createForm(new CollectionType(), $entity, array(
            'action' => $this->generateUrl('media_collection_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GearboxMediaBundle:Collection')->find($id);
        ...
        return $this->render('GearboxMediaBundle:Collection:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GearboxMediaBundle:Collection:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new CollectionType(), $entity, array(
            'action' => $this->generateUrl('media_collection_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('media_collection_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('media_collection'));
    }
